...
export default () => {
  ...
  return (
    <div className="flex gap-x-3 min-h-36 h-fit p-4 border border-solid shadow-lg rounded-2xl w-full">
        ...
        <Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)}>
            <FormField
              ...
              name={"title"}
              render={({ field }) => (
                <Input className="border-0 text-base w-full" placeholder="Title of your post" {...field} />
              )}
            />
